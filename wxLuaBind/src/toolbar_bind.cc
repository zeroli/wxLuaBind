...
BEGIN_WXLUA_BINDFUNC(toolbar)
    ...
    BEGIN_LUA_TABLE(wx)
        // Bind enum  (totally 15)
        BIND_ENUM(wxTB_HORIZONTAL)
        BIND_ENUM(wxTB_TOP)
        BIND_ENUM(wxTB_VERTICAL)
        BIND_ENUM(wxTB_LEFT)
        BIND_ENUM(wxTB_3DBUTTONS)
        BIND_ENUM(wxTB_FLAT)
        BIND_ENUM(wxTB_DOCKABLE)
        BIND_ENUM(wxTB_NOICONS)
        BIND_ENUM(wxTB_TEXT)
        BIND_ENUM(wxTB_NODIVIDER)
        BIND_ENUM(wxTB_NOALIGN)
        BIND_ENUM(wxTB_HORZ_LAYOUT)
        BIND_ENUM(wxTB_HORZ_TEXT)
        BIND_ENUM(wxTB_NO_TOOLTIPS)
        BIND_ENUM(wxTB_BOTTOM)
        BIND_ENUM(wxTB_RIGHT)
