...
#define BIND_WIN_ALL_CTORS() \
    BIND_CTOR_0()\
    .def(constructor<WIN_CREATOR_ARGS_MIN>())\
    .def(constructor<WIN_CREATOR_ARGS_3>())\
    .def(constructor<WIN_CREATOR_ARGS_4>())\
    .def(constructor<WIN_CREATOR_ARGS_5>())\
    .def(constructor<WIN_CREATOR_ARGS_6>())
    // why below cannot compile??
    //BIND_CTOR_2(WIN_CREATOR_ARGS_MIN)\
    //BIND_CTOR_3(WIN_CREATOR_ARGS_3)\
    //BIND_CTOR_4(WIN_CREATOR_ARGS_4)\
    //BIND_CTOR_5(WIN_CREATOR_ARGS_5)\
    //BIND_CTOR_6(WIN_CREATOR_ARGS_6)
...
// why below cannot compile???
//BIND_CTOR_3(TITLE_WIN_CREATOR_ARGS_MIN)\
//BIND_CTOR_4(TITLE_WIN_CREATOR_ARGS_4) \
//BIND_CTOR_5(TITLE_WIN_CREATOR_ARGS_5) \
//BIND_CTOR_6(TITLE_WIN_CREATOR_ARGS_6) \
//BIND_CTOR_7(TITLE_WIN_CREATOR_ARGS_7)
// ============================================
